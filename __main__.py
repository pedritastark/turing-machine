...
Output: Turing machine (string) -> code to be builded in https://turingmachinesimulator.com
'''
def binMachineConverter(binarysecuence: str)-> None:

    moves = {'1': '>', '11': '<', '111': '-'}
    states = {('1' * i): ('q' + str(i)) for i in range(1, 6)}
...
def machineBinConverter(machine: list[list[str]]) -> None:
    ...
    moves = {'>': '1', '<': '11', '-': '111'}
    states = {('q' + str(i)): ('1' * i) for i in range(1, 6)}
...
binarysecuence = '01011011101101001110111011110111010'
machinecode = [['q1','a','q3','a','>'], ['q3', 'b', 'q4', 'b', '>']]
